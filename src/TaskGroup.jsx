   ...
   return (
      <div style={{flex: "1", background: props.pallette.vibr, minWidth: "0",maxWidth: "100%", overflowX: "auto", display: "flex", flexFlow: "column", borderTop: `${props.pallette.bright} solid .5em`}}>
         ...
         <div style={{display: "flex", justifyContent: "space-between", width: "100%", overflow: "hidden", alignItems: "center", marginTop: ".75em", flexWrap: "nowrap"}}>
            ...
            <header style={{alignSelf: "center", color: props.pallette.light, fontSize: "1.5em", marginRight: ".5em"}}>{props.name}<button style={{background: "none", border: "none", color: props.pallette.light, fontSize: ".65em"}}>🔽</button></header>
         </div>
         <div style={{display: "flex", justifyContent: "right", width: "100%", overflow: "hidden"}}>
            <button
               style={{margin: ".5em",padding: ".4em", fontFamily: 'fontHW', fontSize: '.7em', minWidth: "0", borderRadius: "1em", border: "none", background: props.pallette.bright, color: props.pallette.dark}}
            >ADD TASK 🔽</ button>
            <button style={{margin: ".5em", background: "none", border: "none",}}><img src='./vectorGraphics/settings-2-svgrepo-com.svg' style={{width: "2.25em"}}/></button>
         </div>
